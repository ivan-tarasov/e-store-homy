<main id="about-us">
				...
				<section id="our-team">
					...
					<ul class="team-members list-unstyled">
						...
						<li class="team-member">
							<img src="/img/team/1.jpg" alt="" class="profile-pic img-responsive">
							<div class="profile">
								<h3>Сергей Таран <small class="designation">Директор</small></h3>
						...
						<li class="team-member">
							<img src="/img/team/2.jpg" alt="" class="profile-pic img-responsive">
							<div class="profile">
								<h3>Александр Таран <small class="designation">Начальник</small></h3>
								<ul class="social list-unstyled">
									<li>
										<a href="http://facebook.com/">
											<span class="fa-stack fa-lg">
   ...
   <section class="google-map map-holder">
      <script type="text/javascript">
         document.write('<script type="text/javascript" charset="utf-8" src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=hFAJnGqbOmzpDfRFcAe5YS8o_YhHlEV9&width=' + screen.width + '&height=450"></scr'+'ipt>');//two part script end tag.
      </script>
	</section>
