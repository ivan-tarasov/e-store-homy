...
final class App
{
    ...
    private function buildAction(string $class): object
    {
        return match ($class) {
            ...
            AdminOrdersAction::class => new AdminOrdersAction($this->layout, $this->auth, $this->orders, $this->price, $this->locale, $this->tpl),
            AdminOrderShowAction::class => new AdminOrderShowAction($this->layout, $this->auth, $this->orders, $this->users, $this->price, $this->locale, $this->tpl),
            ...
            AdminUsersAction::class => new AdminUsersAction($this->layout, $this->auth, $this->users, $this->orders, $this->tpl),
